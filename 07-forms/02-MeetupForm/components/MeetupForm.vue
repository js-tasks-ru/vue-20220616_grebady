  ...
  <form class="meetup-form" @submit.prevent="handleSubmit()">
    <div class="meetup-form__content">
      ...
      <meetup-agenda-item-form
        ...
        @update:agendaItem="localMeetup.agenda[index] = $event"
      />
...
export default {
  ...
  methods: {
    addAgendaItem() {
      const lengthAgenda = this.localMeetup.agenda.length;
      const newItem = createAgendaItem();
      if (lengthAgenda !== 0) newItem.startsAt = this.localMeetup.agenda[lengthAgenda - 1].endsAt;
